...
```{r cv-pca, fig.cap = "Scree plot using cross validation.", sq.fig = TRUE}
...
```{r scores12, sq.fig = TRUE, fig.cap = "Score plot for PCs 1 and 2. Compare to protocol figure 7a."}
...
```{r hotelling1, sq.fig = TRUE, fig.cap = "Score plot for PCs 1 and 2 with Hotelling's *T*^2^ ellipse. Compare to protocol figure 7a." }
...
```{r loadings, sq.fig = TRUE, fig.cap = "Loadings for PC1 and PC2.", eval = FALSE, echo = FALSE}
