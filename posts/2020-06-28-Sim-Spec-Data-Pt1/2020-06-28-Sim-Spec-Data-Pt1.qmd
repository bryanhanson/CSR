...
date: "2020-06-28"
categories: [R, Simulated Data, SpecHelpers, Baseline]
...
One clever way to introduce baseline anomalies is to use a [Vandermonde matrix](https://en.wikipedia.org/wiki/Vandermonde_matrix). This is a trick I learned while working with the team on the `hyperSpec` overhaul funded by [GSOC](https://chemospec.org/posts/2020-05-07-GSOC-hyperSpec/).[^3]  It's easiest to explain by an example:
