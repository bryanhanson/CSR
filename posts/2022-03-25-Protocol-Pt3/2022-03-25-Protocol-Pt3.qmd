...
```{r fig-scores12, sq.fig = TRUE, fig.cap = "Score plot for PCs 1 and 2. Compare to protocol figure 7d."}
...
```{r fig-loadings, sq.fig = TRUE, fig.cap = "Loadings for PC1 and PC2."}
...
```{r fig-loadingsDetail, sq.fig = TRUE, fig.cap = "Loadings for PC1 and PC2."}
