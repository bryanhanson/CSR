...
In this series of posts, I'll discuss the alignment process for the case of 2D NMR, as implemented in the package `ChemoSpec2D`. This is Part 1.  [Part 2](https://chemospec.org/2020/02/20/p9/). [Part 3](https://chemospec.org/2020/02/20/p10/).
